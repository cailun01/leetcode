...
public:
    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) {
        ...
        while (left < right) {
            ...
            // left和right最小差距是1，此时下面的计算结果如果不加1会出现i一直等于left的情况，而+1之后i才会等于right
